...
public:
  BfLayerBuffer(VmaAllocator allocator, size_t single_vertex_size,
                size_t max_vertex_count, size_t max_obj_count, bool is_nested);
...
BfEvent bfCreateBuffer(BfAllocatedBuffer *allocatedBuffer,
                       VmaAllocator allocator, size_t allocSize,
                       VkBufferUsageFlags usage, VmaMemoryUsage memoryUsage,
                       VmaAllocationCreateFlags flags = 0);

BfEvent bfDestroyBuffer(BfAllocatedBuffer *allocatedBuffer);

BfEvent bfCreateImage(BfAllocatedImage *allocatedImage, VmaAllocator allocator,
                      VkImageCreateInfo *image_create_info,
                      VmaAllocationCreateInfo *alloc_create_info);

BfEvent bfDestroyImage(BfAllocatedImage *allocatedImage);

BfEvent bfCreateImageView(BfAllocatedImage *allocatedImage, VkDevice device,
