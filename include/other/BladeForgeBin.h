...
private:
   ...
   void
   populateMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo);
   ...
   static VKAPI_ATTR VkBool32 VKAPI_CALL debugCallback(
       ...
       /*
               Бывают:
               1. VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT - при
          диагностике много слов;
               2. VK_DEBUG_UTILS_MESSAGE_SEVERITY_INFO_BIT_EXT - информативное
          сообщение, как при создании ресурса;
               3. VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT - сообщение о
          потенциальном баге, НЕ об ошибке;
               4. VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT -
          invalid-behavior или крашы;
       */
       // Тип сообщения
       VkDebugUtilsMessageTypeFlagsEXT messageType,
       /*
               Бывают:
               1. VK_DEBUG_UTILS_MESSAGE_TYPE_GENERAL_BIT_EXT - какой-то event
          произошел, которого не должно было быть;
               2. VK_DEBUG_UTILS_MESSAGE_TYPE_VALIDATION_BIT_EXT - что-то
          произошло, что нарушает спецификацию или говорит о возможной ошибке;
               3. VK_DEBUG_UTILS_MESSAGE_TYPE_PERFORMANCE_BIT_EXT - потенциально
          неоптиманое исполь- зование VK;
