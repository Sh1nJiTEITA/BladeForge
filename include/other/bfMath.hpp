...
public:
   BfMtxColumnIterator(std::vector<T>::iterator b,
                       const size_t             n,
                       const size_t             m);
...
public:
   ...
   {
      return BfMatrixIterator<T>(&__v[i * __m],
                                 __n,
                                 __m,
   ...
   {
      return BfMatrixIterator<T>(&__v[j],
                                 __n,
                                 __m,
   ...
   {
      return BfMatrixIterator<T>(&(*this)(i, __m),
                                 __n,
                                 __m,
                                 BfMatrixIterator<T>::ROW_ITERATOR);
   }
   ...
   {
      return BfMatrixIterator<T>(&(*this)(__n, j),
                                 __n,
                                 __m,
                                 BfMatrixIterator<T>::COL_ITERATOR);
   }
   ...
   {
      return BfMatrixIterator<T>(&(*this)(i, __m - 1),
                                 __n,
                                 __m,
   ...
   {
      return BfMatrixIterator<T>(&(*this)(__n - 1, j),
                                 __n,
                                 __m,
   ...
   {
      return BfMatrixIterator<T>(&(*this)(i, 0),
                                 __n,
                                 __m,
                                 BfMatrixIterator<T>::ROW_ITERATOR_R);
   }
   ...
   {
      return BfMatrixIterator<T>(&(*this)(0, j),
                                 __n,
                                 __m,
                                 BfMatrixIterator<T>::COL_ITERATOR_R);
   }
...
std::pair<BfMatrix2<T>, BfMatrix2<T>> luDecomposition(const BfMatrix2<T> &A)
{
   ...
   for (size_t k = 0; k < n - 1; ++k)
   {
      ...
      if (pivotRow != k)
      {
         std::swap_ranges(U.begin_row(k),
                          U.end_row(k) + 1,
                          U.begin_row(pivotRow));
         std::swap(P[k], P[pivotRow]);
         if (k > 0)
         {
            std::swap_ranges(L.begin_row(k),
                             L.end_row(k) + 1,
