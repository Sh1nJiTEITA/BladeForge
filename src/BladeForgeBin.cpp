...
void BladeForge::createCommandBuffer()
{
...
void BladeForge::createSyncObjects()
{
	...
	if (
		vkCreateSemaphore(device,&semaphoreInfo,nullptr, // 1
			&imageAvailableSemaphore) != VK_SUCCESS ||

		vkCreateSemaphore(device,&semaphoreInfo,nullptr, // 2
