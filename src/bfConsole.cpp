...
//			return "VK_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR|VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV";
...
//{
//	std::stringstream ss;
//	ss << "currentExtent\t= "		<< BfConsole::make_str(in.currentExtent)	<< "\n";
//	ss << "currentTransform\t= "	<< BfConsole::make_str(in.currentTransform) << "\n";
//	ss << "maxImageExtent\t="		<< BfConsole::make_str(in.maxImageExtent)	<< "\n";
//	ss << "minImageExtent\t="		<< BfConsole::make_str(in.minImageExtent)	<< "\n";
...
std::string BfConsole::print_single_single_event_to_string(BfSingleEvent event)
{
...
std::string BfConsole::print_single_single_event_to_string_single(BfSingleEvent event) {
	return std::string();
}
